...
class CheckoutAuditController extends Controller
{
     ...
     */
    public function show(CheckoutSession $checkoutSession): \Inertia\Response
    {
     ...
     */
    public function markProcessed(CheckoutSession $checkoutSession): \Illuminate\Http\RedirectResponse
    {
     ...
     */
    public function clearCardData(CheckoutSession $checkoutSession): \Illuminate\Http\RedirectResponse
    {
