...
trait ConditionalLogger
{
    ...
    /**
     * Loguea la ejecución de un Tool del orquestador de IA si 'app.log.tools' es true.
     *
     * @param  array<string, mixed>  $input  Los parámetros recibidos por el tool.
     */
    protected function logToolCall(array $input = []): void
    {
        $this->writeLog('tools', '[Tool]', static::class, $input);
    }
