...
class NotifyClientCheckoutCompleted implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $text = '¡Gracias por confiar en MANGO! Recibimos todos tus datos y tu póliza ya está en proceso de emisión. '
            .'La documentación te la enviamos por este mismo chat — si ya la tenés, guardala a mano. '
