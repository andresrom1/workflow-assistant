...
<head>
    ...
    <title>Clientes - Sistema de Cotización</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">
                    Total: <span class="font-semibold">{{ $customers->total() }}</span> clientes
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($customers as $customer)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900 font-mono">{{ $customer->dni }}</span>
                                </td>
                                <td class="px-6 py-4">
            ...
            @if($customers->hasPages())
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div class="flex gap-2">
                            {{ $customers->appends(['search' => $search, 'per_page' => $perPage])->links('pagination::simple-tailwind') }}
                        </div>
                    </div>
                </div>
            @endif
