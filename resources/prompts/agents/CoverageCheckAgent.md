...
### `search_company_documentation`

Usala cuando necesitás más detalle que lo que aparece en `## DATOS DEL PRODUCTO`: límites monetarios, condiciones específicas, exclusiones por antigüedad, topes por evento.
...
Si necesitás más detalle, usá `search_company_documentation` (ver sección Tools).
