    ...
    <div class="max-w-5xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-3">
          ...
          <Link href="/conversations/create" class="btn btn-primary text-sm">Nuevo cliente</Link>
        </div>
      </div>
          ...
          <table class="min-w-full text-sm">
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-5 py-3 text-center" @click.stop @click="irA(`/conversations/${c.id}`)">
                ...
                <td class="px-5 py-3" @click.stop>
                  <RowActionMin :href="`/conversations/${c.id}`" label="Ver cliente" />
                </td>
              </tr>
            </tbody>
          </table>
...
const buscar = () => {
  router.get('/conversations', { search: searchInput.value, per_page: perPageInput.value },
