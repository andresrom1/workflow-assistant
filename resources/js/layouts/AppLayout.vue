    ...
    >
      ...
      <nav class="sb-nav flex-1 py-3 overflow-y-auto overflow-x-hidden">
        <NavGroup :label="open ? 'Principal' : ''" :open="open">
          ...
          <NavItem :open="open" href="/polizas" :active="isActive('/polizas')" label="Pólizas">
            <template #icon>
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0
                  0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1
                  1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12
                  3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746
                  3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
              </svg>
            </template>
          </NavItem>
          ...
          <NavItem :open="open" href="/reporte-cartera" :active="isActive('/reporte-cartera')" label="Reporte de cartera">
            <template #icon>
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <NavGroup v-if="auth?.user?.role === 'admin'" :label="open ? 'Administración' : ''" :open="open">
          <NavItem :open="open" href="/admin/facturacion" :active="isActive('/admin/facturacion')" label="Facturación">
            <template #icon>
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25
                  2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15m-6 0V6a3 3 0 1 1 6
                  0v2.25m-6 0h6m-6 3.75h6m-6 3.75h3" />
              </svg>
            </template>
          </NavItem>
