# PAS Mobile — Guía de Estilo Frontend v2.3
...
*Última actualización: versión 2.2 — correcciones de accesibilidad para astigmatismo: reducción de halación en dark mode (`--text-1: #c0c3d8`), contraste WCAG AA en `--text-3`, focus ring visible en fondos oscuros, separadores de tabla más contrastantes, peso tipográfico 500 en dark mode.*
